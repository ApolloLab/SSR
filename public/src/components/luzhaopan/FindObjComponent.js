                    ...
                    <div className="col-m-12">
                        <div class = "row">
                            <div  className="col-md-7 FindObjComponent-object" style={{textAlign:"center"}}>
                                ...
                                <div className="col-m-12" >
                                    <h1>项目概况是指在介绍或论述某个项目时,首先综合性地简要介绍项目的基本情况。比如一个招商项目,它比一般项目概况的内容较全面,包括项目建设内容、建设规模、投资总额、市场前景、经济效益、社会效益、地理位置、交通条件、气候环境、人文环境、优惠政策等内容。</h1>
                                </div>
                            </div>
                                ...
                                <div className="col-m-12" >
                                    <div class="row">
                                        ...
                                        <div className="col-m-4" >
                                            <h1>
                                                <img  style={{width:"80px",height:"100px",backgroundsize:"100% 100%"}} class="img-circle" src={require('../../../images/2.jpg')} alt="头像" />
                                            </h1>
                                        </div>
                                    </div>
                                </div>
